...
func seedPOSProductLinePlans(ctx context.Context, tx *ent.Tx) error {
	...
	plans := []planDef{
		...
		},
		{
			...
			billingCycle: "MONTHLY", price: 5000, setupFee: 10000, tierOrder: 2,
		...
		},
		{
			...
			billingCycle: "MONTHLY", price: 9500, setupFee: 20000, tierOrder: 3,
		...
		// ─── Codevertex Dawa (Pharmacy: chemists, pharmacies, dispensaries) ─────
		{
			...
			billingCycle: "MONTHLY", price: 3500, setupFee: 6000, tierOrder: 1,
			tierLimits: map[string]any{"max_devices": 1, "max_cashiers": 2},
		...
		},
		{
			...
			billingCycle: "MONTHLY", price: 6000, setupFee: 12000, tierOrder: 2,
			tierLimits: map[string]any{"max_devices": 5, "max_cashiers": 10},
		...
		},
		{
			...
			billingCycle: "MONTHLY", price: 11000, setupFee: 22000, tierOrder: 3,
			tierLimits: map[string]any{"max_devices": -1, "max_cashiers": -1},
