...
func seedBundles(ctx context.Context, tx *ent.Tx) error {
	...
	bundles := []bundleDef{
		...
		},
		{
			...
			tiers: []schema.BundleTier{
				{PlanCode: "POS_SUITE_STARTER", MonthlyPrice: 2000, YearlyPrice: 22000},
				{PlanCode: "POS_SUITE_GROWTH", MonthlyPrice: 4500, YearlyPrice: 49500},
				{PlanCode: "POS_SUITE_PROFESSIONAL", MonthlyPrice: 8000, YearlyPrice: 88000},
			},
			sortOrder: 2,
		},
		{
