...
const (
	// Label holds the string label denoting the subscriptionspermission type in the database.
	Label = "subscriptions_permission"
	...
	// Table holds the table name of the subscriptionspermission in the database.
	Table = "subscriptions_permissions"
	// RolesTable is the table that holds the roles relation/edge. The primary key declared below.
	RolesTable = "role_permissions"
	// RolesInverseTable is the table name for the SubscriptionsRole entity.
	// It exists in this package in order to avoid circular dependency with the "subscriptionsrole" package.
	RolesInverseTable = "subscriptions_roles"
...
// Columns holds all SQL columns for subscriptionspermission fields.
var Columns = []string{
	FieldID,
	FieldPermissionCode,
	FieldName,
...
// OrderOption defines the ordering options for the SubscriptionsPermission queries.
