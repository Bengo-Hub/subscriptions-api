...
// SetUser sets the "user" edge to the SubscriptionsUser entity.
func (_u *UserRoleAssignmentUpdate) SetUser(v *SubscriptionsUser) *UserRoleAssignmentUpdate {
	return _u.SetUserID(v.ID)
}

// SetRole sets the "role" edge to the SubscriptionsRole entity.
func (_u *UserRoleAssignmentUpdate) SetRole(v *SubscriptionsRole) *UserRoleAssignmentUpdate {
	...
	if _u.mutation.UserCleared() {
		edge := &sqlgraph.EdgeSpec{
			...
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(subscriptionsuser.FieldID, field.TypeUUID),
			},
		}
...
// SetUser sets the "user" edge to the SubscriptionsUser entity.
func (_u *UserRoleAssignmentUpdateOne) SetUser(v *SubscriptionsUser) *UserRoleAssignmentUpdateOne {
	return _u.SetUserID(v.ID)
}

// SetRole sets the "role" edge to the SubscriptionsRole entity.
func (_u *UserRoleAssignmentUpdateOne) SetRole(v *SubscriptionsRole) *UserRoleAssignmentUpdateOne {
	return _u.SetRoleID(v.ID)
}
