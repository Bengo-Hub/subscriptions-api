...
// SetRole sets the "role" edge to the SubscriptionsRole entity.
func (_u *RolePermissionUpdate) SetRole(v *SubscriptionsRole) *RolePermissionUpdate {
	return _u.SetRoleID(v.ID)
}

// SetPermission sets the "permission" edge to the SubscriptionsPermission entity.
func (_u *RolePermissionUpdate) SetPermission(v *SubscriptionsPermission) *RolePermissionUpdate {
...
// SetRole sets the "role" edge to the SubscriptionsRole entity.
func (_u *RolePermissionUpdateOne) SetRole(v *SubscriptionsRole) *RolePermissionUpdateOne {
	return _u.SetRoleID(v.ID)
}

// SetPermission sets the "permission" edge to the SubscriptionsPermission entity.
func (_u *RolePermissionUpdateOne) SetPermission(v *SubscriptionsPermission) *RolePermissionUpdateOne {
	return _u.SetPermissionID(v.ID)
}
