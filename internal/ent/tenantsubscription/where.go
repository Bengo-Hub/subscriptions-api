...
func HasEmailLicenses() predicate.TenantSubscription {
	return predicate.TenantSubscription(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasEmailLicensesWith(preds ...predicate.EmailLicense) predicate.TenantSubscription {
	return predicate.TenantSubscription(func(s *sql.Selector) {
...
// HasEmailDomains applies the HasEdge predicate on the "email_domains" edge.
func HasEmailDomains() predicate.TenantSubscription {
	return predicate.TenantSubscription(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasEmailDomainsWith applies the HasEdge predicate on the "email_domains" edge with a given conditions (other predicates).
func HasEmailDomainsWith(preds ...predicate.TenantEmailDomain) predicate.TenantSubscription {
	return predicate.TenantSubscription(func(s *sql.Selector) {
		step := newEmailDomainsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
...
// HasSupportFeeCycles applies the HasEdge predicate on the "support_fee_cycles" edge.
func HasSupportFeeCycles() predicate.TenantSubscription {
	return predicate.TenantSubscription(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasSupportFeeCyclesWith applies the HasEdge predicate on the "support_fee_cycles" edge with a given conditions (other predicates).
func HasSupportFeeCyclesWith(preds ...predicate.SupportFeeCycle) predicate.TenantSubscription {
	return predicate.TenantSubscription(func(s *sql.Selector) {
		step := newSupportFeeCyclesStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
