...
func HasRoleWith(preds ...predicate.SubscriptionsRole) predicate.RolePermission {
	return predicate.RolePermission(func(s *sql.Selector) {
		step := newRoleStep()
...
func HasPermissionWith(preds ...predicate.SubscriptionsPermission) predicate.RolePermission {
	return predicate.RolePermission(func(s *sql.Selector) {
