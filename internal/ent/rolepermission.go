...
type RolePermissionEdges struct {
	...
	Permission *SubscriptionsPermission `json:"permission,omitempty"`
...
func (e RolePermissionEdges) RoleOrErr() (*SubscriptionsRole, error) {
	if e.Role != nil {
		return e.Role, nil
...
// was not loaded in eager-loading, or loaded but was not found.
func (e RolePermissionEdges) PermissionOrErr() (*SubscriptionsPermission, error) {
	if e.Permission != nil {
		return e.Permission, nil
	} else if e.loadedTypes[1] {
		return nil, &NotFoundError{label: subscriptionspermission.Label}
	}
...
func (_m *RolePermission) QueryRole() *SubscriptionsRoleQuery {
...
func (_m *RolePermission) QueryPermission() *SubscriptionsPermissionQuery {
