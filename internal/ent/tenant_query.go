...
func (_q *TenantQuery) QuerySubscriptions() *TenantSubscriptionQuery {
...
func (_q *TenantQuery) WithSubscriptions(opts ...func(*TenantSubscriptionQuery)) *TenantQuery {
	query := (&TenantSubscriptionClient{config: _q.config}).Query()
...
func (_q *TenantQuery) loadSubscriptions(ctx context.Context, query *TenantSubscriptionQuery, nodes []*Tenant, init func(*Tenant), assign func(*Tenant, *TenantSubscription)) error {
