...
func (_q *ProductQuery) QueryProductSubscriptions() *ProductSubscriptionQuery {
...
func (_q *ProductQuery) WithProductSubscriptions(opts ...func(*ProductSubscriptionQuery)) *ProductQuery {
	query := (&ProductSubscriptionClient{config: _q.config}).Query()
...
func (_q *ProductQuery) loadProductSubscriptions(ctx context.Context, query *ProductSubscriptionQuery, nodes []*Product, init func(*Product), assign func(*Product, *ProductSubscription)) error {
