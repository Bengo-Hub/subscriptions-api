...
type RolePermissionQuery struct {
	...
	withRole       *SubscriptionsRoleQuery
	withPermission *SubscriptionsPermissionQuery
...
func (_q *RolePermissionQuery) QueryRole() *SubscriptionsRoleQuery {
...
func (_q *RolePermissionQuery) QueryPermission() *SubscriptionsPermissionQuery {
...
func (_q *RolePermissionQuery) WithRole(opts ...func(*SubscriptionsRoleQuery)) *RolePermissionQuery {
	query := (&SubscriptionsRoleClient{config: _q.config}).Query()
...
func (_q *RolePermissionQuery) WithPermission(opts ...func(*SubscriptionsPermissionQuery)) *RolePermissionQuery {
	query := (&SubscriptionsPermissionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *RolePermissionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*RolePermission, error) {
	...
	if query := _q.withRole; query != nil {
		if err := _q.loadRole(ctx, query, nodes, nil,
			func(n *RolePermission, e *SubscriptionsRole) { n.Edges.Role = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withPermission; query != nil {
		if err := _q.loadPermission(ctx, query, nodes, nil,
			func(n *RolePermission, e *SubscriptionsPermission) { n.Edges.Permission = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *RolePermissionQuery) loadRole(ctx context.Context, query *SubscriptionsRoleQuery, nodes []*RolePermission, init func(*RolePermission), assign func(*RolePermission, *SubscriptionsRole)) error {
	...
	query.Where(subscriptionsrole.IDIn(ids...))
...
func (_q *RolePermissionQuery) loadPermission(ctx context.Context, query *SubscriptionsPermissionQuery, nodes []*RolePermission, init func(*RolePermission), assign func(*RolePermission, *SubscriptionsPermission)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*RolePermission)
	for i := range nodes {
	...
	query.Where(subscriptionspermission.IDIn(ids...))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	}
