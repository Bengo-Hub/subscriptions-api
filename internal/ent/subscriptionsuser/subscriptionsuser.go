...
const (
	// Label holds the string label denoting the subscriptionsuser type in the database.
	Label = "subscriptions_user"
	...
	// Table holds the table name of the subscriptionsuser in the database.
	Table = "subscriptions_users"
)

// Columns holds all SQL columns for subscriptionsuser fields.
var Columns = []string{
	FieldID,
	FieldTenantID,
...
// OrderOption defines the ordering options for the SubscriptionsUser queries.
