...
// SubscriptionsUser holds the schema definition for subscriptions service users.
type SubscriptionsUser struct {
	ent.Schema
}

// Fields of the SubscriptionsUser.
func (SubscriptionsUser) Fields() []ent.Field {
	return []ent.Field{
...
// Indexes of the SubscriptionsUser.
func (SubscriptionsUser) Indexes() []ent.Index {
	return []ent.Index{
