...
const (
	// Label holds the string label denoting the subscriptionsrole type in the database.
	Label = "subscriptions_role"
	...
	// Table holds the table name of the subscriptionsrole in the database.
	Table = "subscriptions_roles"
	...
	// PermissionsInverseTable is the table name for the SubscriptionsPermission entity.
	// It exists in this package in order to avoid circular dependency with the "subscriptionspermission" package.
	PermissionsInverseTable = "subscriptions_permissions"
	...
	UserAssignmentsColumn = "subscriptions_role_user_assignments"
...
// Columns holds all SQL columns for subscriptionsrole fields.
var Columns = []string{
	FieldID,
	FieldTenantID,
	FieldRoleCode,
...
// OrderOption defines the ordering options for the SubscriptionsRole queries.
