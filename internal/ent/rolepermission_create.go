...
func (_c *RolePermissionCreate) SetRole(v *SubscriptionsRole) *RolePermissionCreate {
	return _c.SetRoleID(v.ID)
}

// SetPermission sets the "permission" edge to the SubscriptionsPermission entity.
func (_c *RolePermissionCreate) SetPermission(v *SubscriptionsPermission) *RolePermissionCreate {
